...
INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu , R, R(rd) = src1 < src2); // warn: "right shift a negative number"'s behavior(arithmetic or logical) depends on the compiler 
